...
class CPPLibrary:
    ...
    def _init_functions(self):
        ...
        self.lib.cuda_available_cpp.argtypes = []
        self.lib.cuda_available_cpp.restype = ct.c_bool
        self.lib.cuda_last_error_cpp.argtypes = []
        self.lib.cuda_last_error_cpp.restype = ct.c_char_p
        self.lib.cuda_run_random_rollouts_cpp.argtypes = [
            ct.c_int,
            ct.c_int,
            ct.c_int,
            ct.c_int,
        ...
        self.lib.cuda_run_random_rollouts_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_create_cpp.argtypes = [
            ct.c_int,
            ct.c_ulonglong,
            ct.c_int,
        ]
        self.lib.cuda_blackout_vec_create_cpp.restype = ct.c_void_p
        self.lib.cuda_blackout_vec_close_cpp.argtypes = [
            ct.c_void_p,
        ]
        self.lib.cuda_blackout_vec_reset_cpp.argtypes = [
            ct.c_void_p,
            ct.POINTER(ct.c_float),
            ct.POINTER(ct.c_bool),
        ]
        self.lib.cuda_blackout_vec_reset_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_step_cpp.argtypes = [
            ct.c_void_p,
            ct.POINTER(ct.c_int),
            ct.POINTER(ct.c_float),
            ct.POINTER(ct.c_float),
        ...
        self.lib.cuda_blackout_vec_step_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_reset_device_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
        ]
        self.lib.cuda_blackout_vec_reset_device_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_reset_all_device_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
        ]
        self.lib.cuda_blackout_vec_reset_all_device_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_reset_all_device_async_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
            ct.c_bool,
        ...
        self.lib.cuda_blackout_vec_reset_all_device_async_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_step_device_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
            ct.c_ulonglong,
        ...
        self.lib.cuda_blackout_vec_step_device_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_step_all_device_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
            ct.c_ulonglong,
        ...
        self.lib.cuda_blackout_vec_step_all_device_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_step_all_device_async_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
            ct.c_ulonglong,
        ...
        self.lib.cuda_blackout_vec_step_all_device_async_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_step_all_eval_device_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_int,
            ct.c_ulonglong,
        ...
        self.lib.cuda_blackout_vec_step_all_eval_device_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_best_actions_device_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
        ]
        self.lib.cuda_blackout_vec_best_actions_device_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_best_actions_device_async_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
            ct.c_ulonglong,
        ]
        self.lib.cuda_blackout_vec_best_actions_device_async_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_heuristic_actions_device_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
        ]
        self.lib.cuda_blackout_vec_heuristic_actions_device_cpp.restype = ct.c_int
        self.lib.cuda_blackout_vec_heuristic_actions_device_async_cpp.argtypes = [
            ct.c_void_p,
            ct.c_ulonglong,
            ct.c_ulonglong,
            ct.c_ulonglong,
        ]
        self.lib.cuda_blackout_vec_heuristic_actions_device_async_cpp.restype = (
            ct.c_int
        )

    def cuda_available(self) -> bool:
        return bool(self.lib.cuda_available_cpp())

    def cuda_last_error(self) -> str:
        raw = self.lib.cuda_last_error_cpp()
        if raw is None:
            return ""
